...
var ProfileService = (function () {
    ...
    ProfileService.prototype.addProfile = function (testData) {
        return this.http
            .post(this.url, JSON.stringify(testData), { headers: this.authService.authJsonHeaders() })
            .map(function (resp) { return resp.json(); })
            .catch(this.handleError);
    };
    ProfileService.prototype.editProfile = function (testData) {
        return this.http
            .put(this.url, JSON.stringify(testData), { headers: this.authService.authJsonHeaders() })
            .map(function (resp) { return resp.json(); })
            .catch(this.handleError);
    };
    ProfileService.prototype.deleteProfile = function (itemToDelete) {
