...
var BlogComponent = (function () {
    function BlogComponent(sampleDataService, errorMessageService) {
    ...
    BlogComponent.prototype.initTestData = function () {
    ...
    BlogComponent.prototype.changeMode = function (newMode, thisItem, event) {
    ...
    BlogComponent.prototype.selectCurrentItem = function (thisItem, event) {
        event.preventDefault();
        this.selectedItem = thisItem;
        this.testData = Object.assign({}, thisItem);
    };
    BlogComponent.prototype.addTestData = function (event) {
        var _this = this;
        event.preventDefault();
        if (!this.testData) {
            return;
    ...
    BlogComponent.prototype.getTestData = function () {
        var _this = this;
    ...
    BlogComponent.prototype.editTestData = function (event) {
        var _this = this;
        event.preventDefault();
        if (!this.testData) {
            return;
    ...
    BlogComponent.prototype.deleteRecord = function (itemToDelete, event) {
        var _this = this;
        event.preventDefault();
