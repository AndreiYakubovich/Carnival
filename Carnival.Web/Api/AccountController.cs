...
using Carnival.Web.Controllers;
...
namespace Carnival.Web.Api
{
    ...
    public class AccountController : Controller
    {
        ...
        private static IMaintenanceService _maintenanceService;
        ...
        {
            _maintenanceService.EnsureDatabaseCreated();
            ViewData["ReturnUrl"] = returnUrl;
            if (ModelState.IsValid)
            {
                // This doesn't count login failures towards account lockout
                // To enable password failures to trigger account lockout, set lockoutOnFailure: true
                Microsoft.AspNetCore.Identity.SignInResult result = await _accountService.Login(model);
        ...
        public async Task<IActionResult> Register([FromBody]RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _accountService.SignIn(user, false);
                    return RedirectToLocal(returnUrl);
                }
                AddErrors(result);
            }
